...
export const Button = ({
  ...
  const baseClasses = 'btn flex items-center justify-center gap-2 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2';
  const variantClasses = {
    primary: 'btn-primary bg-primary text-white hover:bg-primary-hover',
